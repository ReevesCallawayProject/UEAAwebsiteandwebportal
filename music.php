...
<td>
<img src="logo.jpg" alt="images"  style="width:160px;height:160px;position:relative;z-index:10;" id="homelogo" class="logo" >
</td>
<td>
...
<td>
<input name="aboutbtn" type="button" class="navtabs" id="about" value="About UEAA" onclick="window.location='ueaaabout.php'"/>
